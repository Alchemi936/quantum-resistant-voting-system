    ...
    return (<main className="p-4">
      ...
      <form onSubmit={handleVoteSubmit} className="mb-4">
        <label className="block mb-2">
          Voter ID:
          <input type="text" value={voterId} onChange={(e) => setVoterId(e.target.value)} className="border p-2 w-full"/>
        </label>
        <label className="block mb-2">
          Candidate ID:
          <input type="text" value={candidateId} onChange={(e) => setCandidateId(e.target.value)} className="border p-2 w-full"/>
        </label>
        <label className="block mb-2">
          Encrypted Vote:
          <input type="text" value={encryptedVote} onChange={(e) => setEncryptedVote(e.target.value)} className="border p-2 w-full"/>
        </label>
